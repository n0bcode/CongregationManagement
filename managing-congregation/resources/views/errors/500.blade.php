<x-guest-layout>
    <div class="text-center">
        <h1 class="text-6xl font-bold text-stone-800 dark:text-stone-200 mb-4">500</h1>
        <h2 class="text-2xl font-semibold text-stone-600 dark:text-stone-400 mb-6">Server Error</h2>
        <p class="text-stone-500 dark:text-stone-400 mb-8">
            {{ __($exception->getMessage() ?: 'Whoops, something went wrong on our servers.') }}
        </p>

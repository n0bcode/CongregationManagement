<x-guest-layout>
    <div class="text-center">
        <h1 class="text-6xl font-bold text-stone-800 dark:text-stone-200 mb-4">403</h1>
        <h2 class="text-2xl font-semibold text-stone-600 dark:text-stone-400 mb-6">Access Forbidden</h2>

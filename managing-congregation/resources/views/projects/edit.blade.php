<x-app-layout>
    <x-slot name="header">
        <x-ui.page-header title="{{ __('Edit Project') }}" />
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('projects.update', $project) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-forms.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $project->name)" required autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-forms.text-input id="start_date" class="block mt-1 w-full" type="date" name="start_date" :value="old('start_date', $project->start_date?->format('Y-m-d'))" />
                                <x-forms.input-error :messages="$errors->get('start_date')" class="mt-2" />
                            </div>
                            <div>
                                <x-forms.input-label for="end_date" :value="__('End Date')" />
                                <x-forms.text-input id="end_date" class="block mt-1 w-full" type="date" name="end_date" :value="old('end_date', $project->end_date?->format('Y-m-d'))" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-forms.text-input id="budget" class="block mt-1 w-full" type="number" step="0.01" name="budget" :value="old('budget', $project->budget)" required />

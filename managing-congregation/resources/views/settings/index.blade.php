                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="border-b border-gray-200 mb-6">
                        <nav class="-mb-px flex space-x-8">
                            ...
                            <a href="{{ route('admin.settings.footer.edit') }}" class="whitespace-nowrap py-4 px-1 border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 font-medium text-sm">
                                Footer
                            </a>
                        </nav>
                    </div>

...
- [ ] 1.1 Run Laravel Pint and fix code style issues

  - Execute `./vendor/bin/pint` and resolve all violations
  - Ensure PSR-12 compliance
  - _Requirements: 1.1_

- [ ] 1.2 Audit database migrations for foreign key constraints
...
- [ ] 1.3 Audit model relationships and add return types
...
- [ ] 1.5 Audit routes for middleware and authorization
...
- [ ]\* 1.6 Write property test for route authorization

  - **Property 2: Routes Have Authorization Middleware**
  - **Validates: Requirements 1.4**

- [ ] 1.7 Test Docker configuration
...
- [ ] 2.1 Implement Tailwind config with Sanctuary & Stone palette
...
- [ ] 2.2 Create base button component
...
- [ ] 2.4 Create ledger-row component
...
- [ ] 2.5 Create timeline-node component
...
- [ ]\* 2.6 Write property test for component reuse

  - **Property 22: Blade Components Are Reused**
  - **Validates: Requirements 8.3**

- [ ] 2.7 Update app layout with accessibility features
...
- [ ] 3.1 Create health_records migration and model
...
- [ ] 3.2 Create skills migration and model
...
- [ ]\* 3.3 Write property test for health data persistence
...
- [ ] 3.5 Enhance member search functionality
...
- [ ] 3.7 Create member profile view with tabs
...
- [ ] 3.8 Create health records management UI
...
- [ ] 3.9 Create skills management UI
...
- [ ] 4.1 Create audit_logs migration and model
...
- [ ] 4.3 Create AuditObserver for Member model
...
- [ ] 4.5 Add audit logging for member transfers
...
- [ ] 4.8 Create audit log viewer UI
...
- [ ] 4.10 Implement tamper-evident export
...
- [ ] 5.1 Create expenses migration (if not exists)
...
- [ ] 5.2 Create Expense model with validation
...
- [ ] 5.5 Create FinancialController
...
- [ ] 5.11 Implement General Treasurer read-only access
...
- [ ] 5.13 Create PdfService for reports
...
- [ ] 5.14 Create monthly report view template
...
- [ ] 6.1 Create documents and folders migrations
...
- [ ] 6.2 Create Document and Folder models
...
- [ ] 6.7 Implement RBAC for documents
...
- [ ] 6.9 Implement temporary signed URLs
...
- [ ] 6.11 Create document management UI
...
- [ ] 7.1 Create reminders migration and model
...
- [ ] 7.2 Create NotificationService
...
- [ ] 7.5 Create scheduled command for reminders

  - Create app/Console/Commands/SendReminders.php
  - Schedule in app/Console/Kernel.php
  - _Requirements: 6.1, 6.2_

- [ ] 7.6 Create system_settings migration and model
...
- [ ] 7.8 Create dashboard notifications widget
...
- [ ] 8.1 Verify assignments table structure

  - Check assignments migration
  - Ensure proper date fields and indexes
  - _Requirements: 10.1, 10.2_

- [ ] 8.2 Add timeline() method to Member model
...
- [ ] 8.3 Create ServiceHistoryController
...
- [ ] 8.5 Add automatic timeline entry for transfers
...
- [ ] 8.7 Add duration calculation to Assignment model
...
- [ ] 8.9 Enhance member profile PDF export
...
- [ ] 8.11 Create timeline visualization UI
...
- [ ] 9.1 Create DashboardController
...
- [ ] 9.8 Implement chart generation
...
- [ ]\* 10.4 Write property test for card generation performance

  - **Property 33: Celebration Card Generation Performance**
  - **Validates: Requirements 11.3**

- [ ] 10.5 Implement card download and email

  - Add download functionality
  - Add email sending functionality
  - _Requirements: 11.4_

- [ ] 10.6 Create upcoming celebrations widget

  - Add to dashboard
  - Filter events within 30 days
  - _Requirements: 11.5_

- [ ]\* 10.7 Write property test for upcoming celebrations filter
...
- [ ] 11.1 Create SettingsController
...
- [ ] 11.2 Create settings management UI
...
- [ ]\* 11.3 Write property test for service year default

  - **Property 35: Service Year Defaults New Assignments**
  - **Validates: Requirements 12.1**

- [ ]\* 11.4 Write property test for reminder period changes

  - **Property 36: Reminder Period Changes Apply Globally**
  - **Validates: Requirements 12.2**

- [ ] 11.5 Implement email settings validation

  - Add SMTP connection test
  - Validate before saving
  - _Requirements: 12.4_

- [ ]\* 11.6 Write property test for email validation

  - **Property 37: Email Settings Are Validated**
  - **Validates: Requirements 12.4**

- [ ] 11.7 Implement backup system
...
- [ ]\* 11.8 Write property test for daily backups
...
- [ ] 12.1 Add database indexes
  ...
  - _Requirements: 13.5_
- [ ]\* 12.2 Write property test for dashboard performance

  - **Property 39: Dashboard Loads Under 2 Seconds**
  - **Validates: Requirements 13.1**

- [ ]\* 12.3 Write property test for search performance

  - **Property 40: Member Search Performance**
  - **Validates: Requirements 13.2**

- [ ] 12.4 Implement photo optimization
...
- [ ] 14.2 Add alt text to all images
...
- [ ] 14.5 Verify color contrast ratios
...
- [ ] 14.6 Add prefers-reduced-motion support
...
- [ ] 15.1 Create custom error messages

  - Update all FormRequests
  - Replace technical messages with user-friendly text
  - _Requirements: 8.2_

- [ ]\* 15.2 Write property test for error message kindness
...
- [ ] 15.4 Create 403 and 404 error pages
